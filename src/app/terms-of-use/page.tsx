...
function TermsContent() {
    ...
    return (
        <>
            <SEOHead
                title="Terms of Use - RELYmedia - Promotional Products"
                description="Review RELYmedia's terms of use for our website, products, and services. Understand our policies and restrictions."
            />
            <Suspense fallback={
